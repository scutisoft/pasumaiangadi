              ...
              child: Row(
                  ...
                  children: [
                    GestureDetector(
                        ...
                        child: Icon(Icons.home_filled,color:Color(0xff6A8528),size: 30,)
                    ),
                    GestureDetector(
                        onTap: (){
                    ...
                    Container(
                        child: Icon(Icons.receipt,color:Color(0xffffffff),size: 30,)
                    ),
                    GestureDetector(
                        onTap: (){
                          // Navigator.push(context, MaterialPageRoute(builder: (context)=>MYOrderDetails()),);
                        },
                        child: Icon(Icons.online_prediction_rounded,color:Color(0xff7B869A),size: 30,)
                    ),
                    GestureDetector(
                        onTap: (){
